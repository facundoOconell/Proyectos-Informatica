...
public class Juego2 extends JFrame {
    ...
    private void cargarImagenes() {
        ...
        muro2Image = new ImageIcon("D:\\PacMan\\src\\Imagenes\\muro2.png").getImage(); 
    }
    ...
    private void inicializarInterfaz() {
        ...
        labelpower.setForeground(Color.BLUE);
    ...
    private void iniciarContadorTiempo() {
        Timer tiempoTimer = new Timer(1000, e -> {
            ...
            // Actualizar el label del power-up cada segundo
            if (pacman2.isSpeedBoostActive()) {
                labelpower.setText("Tiempo Power-up: " + pacman2.getRemainingBoostTime());
                if (pacman2.getRemainingBoostTime() <= 0) {
                    labelpower.setText("Tiempo Power-up: 0");
                }
            } else {
                labelpower.setText("Tiempo Power-up: 0");
            }
    ...
    private void verificarColision() {
    	 ...
    	 int pacmanTileX = (int) Math.floor(pacman2.getX());
         int pacmanTileY = (int) Math.floor(pacman2.getY());
         ...
         if (pacmanTileX >= 0 && pacmanTileX < COLUMNAS && pacmanTileY >= 0 && pacmanTileY < FILAS) {
             if (mapa[pacmanTileY][pacmanTileX] == 'M') {
                 ...
                 pacman2.activateSpeedBoost(); // Activar el power-up
                 labelpower.setText("Tiempo Power-up: " + pacman2.getRemainingBoostTime()); // Actualizar label inmediatamente
             }
             if (pacmanTileX >= 0 && pacmanTileX < COLUMNAS && pacmanTileY >= 0 && pacmanTileY < FILAS) {
